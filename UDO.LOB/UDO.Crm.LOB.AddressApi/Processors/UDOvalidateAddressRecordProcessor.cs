...
namespace UDO.Crm.LOB.Processors.Address
{
    public class UDOvalidateAddressRecordProcessor
    {
        ...
        public IMessageBase Execute(Messages.Address.UDOValidateAddressRequest request)
        {
            var progressString = "Top of Processor";
            LogBuffer = string.Empty;
            _debug = request.Debug;

            Messages.Address.UDOValidateAddressResponse Response = new Messages.Address.UDOValidateAddressResponse(); 
            ...
            try
            {
                var fnaddvalvnAddressValidatorRequest = new VEISfnaddvalvnAddressValidatorRequest
                {
                ...
                {
                    fnaddvalvnAddressValidatorRequest.LegacyServiceHeaderInfo = new VEIS.Core.Messages.LegacyHeaderInfo
                    {
                ...
                var EC_Response =  WebApiUtility.SendReceive<VEISfnaddvalvnAddressValidatorResponse>(fnaddvalvnAddressValidatorRequest, WebApiType.VEIS);
                ...
                if (EC_Response.VEISfnaddvalreturnInfo != null)
                {
                    string address1Concat = string.Empty;
                    var ptcpntAddrsDTO = EC_Response.VEISfnaddvalreturnInfo.VEISfnaddvalgroup1AddressInfo;
