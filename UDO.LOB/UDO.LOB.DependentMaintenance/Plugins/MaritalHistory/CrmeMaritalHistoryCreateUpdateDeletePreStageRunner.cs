...
namespace VRM.CRME.Plugin.DependentMaintenance
{
    ...
    public class CrmeMaritalHistoryCreateUpdateDeletePreStageRunner : MCSPlugins.PluginRunner
    {
        #region Constructor
        public CrmeMaritalHistoryCreateUpdateDeletePreStageRunner(IServiceProvider serviceProvider)
        ...
        private crme_dependentmaintenance GetCrmeDependentMaint()
        {
            ...
            var entity = (EntityReference)primaryEntity["crme_dependentmaintenance"];
            
            var entRefId = entity.Id;
            
            var retrieve = OrganizationService.Retrieve("crme_dependentmaintenance", 
                entRefId, 
                col);

            var crmeDependent = retrieve.ToEntity<crme_dependentmaintenance>();
        ...
        {
            get { return "crme_maritalhistory"; }
        }
