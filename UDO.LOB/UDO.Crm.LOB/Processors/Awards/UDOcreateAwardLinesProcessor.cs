...
namespace VRM.Integration.UDO.Awards.Processors
{
    class UDOcreateAwardLinesProcessor
    {
        ...
        private const string method = "UDOcreateAwardLinesProcessor";
        private string LogBuffer { get; set; }

        public IMessageBase Execute(UDOcreateAwardLinesRequest request)
        {
            //var request = message as createAwardLinesRequest;
            ...
            try
            {
                ...
                if (findOtherAwardInformationResponse.VIMTfoawdinforeturnclmsInfo.VIMTfoawdinfoawardLinesclmsInfo != null)
                {
                    var awardLine = findOtherAwardInformationResponse.VIMTfoawdinforeturnclmsInfo.VIMTfoawdinfoawardLinesclmsInfo;
                    ...
                    foreach (var awardLineItem in awardLine)
                    {
                        ...
                        var awardLineReasons = awardLineItem.VIMTfoawdinfoawardReasonsclmsInfo;
                        var finalReason = "";
                        if (awardLineItem.VIMTfoawdinfoawardReasonsclmsInfo != null)
                        {
                ...
                LogHelper.LogInfo(request.OrganizationName, request.Debug, request.UserId, "Award Lines Created", logInfo);                
                ...
                if (request.AwardId != null)
                {
                    ...
                    OrgServiceProxy.Update(TruncateHelper.TruncateFields(award, request.OrganizationName, request.UserId, request.LogTiming));
                }
                return response;
            }
