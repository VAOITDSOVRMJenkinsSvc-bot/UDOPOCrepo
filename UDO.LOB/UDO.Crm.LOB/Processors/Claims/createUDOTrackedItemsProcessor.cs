    ...
    class UDOcreateUDOTrackedItemsProcessor
    {
        ...
        public IMessageBase Execute(UDOcreateUDOTrackedItemsRequest request)
        {
            ...
            try
            {
                ...
                var findTrackedItemsResponse = new VIMTfindTrackedItemsResponse();
                // var findTrackedItemsResponse = findTrackedItemsRequest.SendReceive<VIMTfindTrackedItemsResponse>(MessageProcessType.Local);
