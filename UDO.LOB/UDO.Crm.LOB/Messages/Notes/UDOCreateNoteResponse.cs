...
namespace VRM.Integration.UDO.Notes.Messages
{
    ...
    [ExportMetadata("MessageType", MessageRegistry.UDOCreateNoteResponse)]
    [DataContract]
    public class UDOCreateNoteResponse : UDOResponseBase
    {
        [DataMember]
    ...
    public class UDOCreateNoteResponseInfo
    {
        ...
        [DataMember]
        public DateTime udo_DateTime { get; set; }
        [DataMember]
