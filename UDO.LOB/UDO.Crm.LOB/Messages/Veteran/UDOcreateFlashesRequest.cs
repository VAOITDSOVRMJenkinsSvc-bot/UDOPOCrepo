...
namespace VRM.Integration.UDO.Contact.Messages
{
    ...
    [ExportMetadata("MessageType", VRMMessages.MessageRegistry.UDOcreateFlashesRequest)]
    [DataContract]
    public class UDOcreateFlashesRequest : MessageBase
    {
        ...
        [DataMember]
        public VIMTfgenpidfindGeneralInformationByPtcpntIdsResponse ECResponse { get; set; }
        [DataMember]
