...
namespace VEIS.FMCService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.FMCService,GetPaymentHistoryDetails method, Request.
	/// Code Generated by IMS on: 1/7/2019 8:05:59 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISFMCgphdGetPaymentHistoryDetailsRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISFMCgphdReqPaymentHistory VEISFMCgphdReqPaymentHistoryInfo { get; set; }
	}
	[DataContract]
	public class VEISFMCgphdReqPaymentHistory
	{
		[DataMember]
