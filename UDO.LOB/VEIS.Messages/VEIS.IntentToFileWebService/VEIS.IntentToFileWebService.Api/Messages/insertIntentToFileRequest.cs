...
namespace VEIS.IntentToFileWebService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.IntentToFileWebService,insertIntentToFile method, Request.
	/// Code Generated by IMS on: 1/7/2019 8:16:21 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISinsertInt2FileinsertIntentToFileRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISinsertInt2FileReqintentToFileDTO VEISinsertInt2FileReqintentToFileDTOInfo { get; set; }
	}
	[DataContract]
	public class VEISinsertInt2FileReqintentToFileDTO
	{
		[DataMember]
