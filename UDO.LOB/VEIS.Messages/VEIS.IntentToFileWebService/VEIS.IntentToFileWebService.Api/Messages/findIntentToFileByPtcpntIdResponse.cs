...
namespace VEIS.IntentToFileWebService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.IntentToFileWebService,findIntentToFileByPtcpntId method, Response.
	/// Code Generated by IMS on: 1/7/2019 8:15:15 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISfindInt2FilePrtId_findIntentToFileByPtcpntIdResponse : VEISEcResponseBase
	{
		[DataMember]
		public VEISfindInt2FilePrtId_intentToFileDTOMultipleResponse[] VEISfindInt2FilePrtId_intentToFileDTOInfo { get; set; }
	}
	[DataContract]
	public class VEISfindInt2FilePrtId_intentToFileDTOMultipleResponse
	{
		[DataMember]
		...
		[DataMember]
		public DateTime mcs_statusDt { get; set; }
		[DataMember]
