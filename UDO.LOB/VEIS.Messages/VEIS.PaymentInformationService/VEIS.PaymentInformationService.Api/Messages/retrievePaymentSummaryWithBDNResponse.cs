...
namespace VEIS.PaymentInformationService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.PaymentInformationService,retrievePaymentSummaryWithBDN method, Response.
	/// Code Generated by IMS on: 12/27/2018 5:00:18 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISrtvpmtsumbdnrretrievePaymentSummaryWithBDNResponse : VEISEcResponseBase
	{
		[DataMember]
		public VEISrtvpmtsumbdnrpaymentSummaryResponseVO VEISrtvpmtsumbdnrpaymentSummaryResponseVOInfo { get; set; }
	}
	[DataContract]
	public class VEISrtvpmtsumbdnrpaymentSummaryResponseVO
	{
		[DataMember]
		public VEISrtvpmtsumbdnrpaymentsMultipleResponse[] VEISrtvpmtsumbdnrpaymentsInfo { get; set; }
		[DataMember]
		public VEISrtvpmtsumbdnrresponse VEISrtvpmtsumbdnrresponseInfo { get; set; }
	}
	[DataContract]
	public class VEISrtvpmtsumbdnrpaymentsMultipleResponse
	{
		[DataMember]
		...
		[DataMember]
		public VEISrtvpmtsumbdnraddressEFT VEISrtvpmtsumbdnraddressEFTInfo { get; set; }
		[DataMember]
		public VEISrtvpmtsumbdnrcheckAddress VEISrtvpmtsumbdnrcheckAddressInfo { get; set; }
		[DataMember]
		public VEISrtvpmtsumbdnrpaymentRecordIdentifier VEISrtvpmtsumbdnrpaymentRecordIdentifierInfo { get; set; }
		[DataMember]
		public VEISrtvpmtsumbdnrreturnPayment VEISrtvpmtsumbdnrreturnPaymentInfo { get; set; }
	}
	[DataContract]
	public class VEISrtvpmtsumbdnraddressEFT
	{
		[DataMember]
	...
	[DataContract]
	public class VEISrtvpmtsumbdnrcheckAddress
	{
		[DataMember]
	...
	[DataContract]
	public class VEISrtvpmtsumbdnrpaymentRecordIdentifier
	{
		[DataMember]
	...
	[DataContract]
	public class VEISrtvpmtsumbdnrreturnPayment
	{
		[DataMember]
	...
	[DataContract]
	public class VEISrtvpmtsumbdnrresponse
	{
		[DataMember]
