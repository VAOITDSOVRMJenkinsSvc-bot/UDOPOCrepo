...
namespace VEIS.VIAEMRService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.VIAEMRService,getAppointmentText method, Request.
	/// Code Generated by IMS on: 12/28/2018 9:14:42 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISEMRgatgetAppointmentTextRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISEMRgatReqqueryBean VEISEMRgatReqqueryBeanInfo { get; set; }
	}
	[DataContract]
	public class VEISEMRgatReqqueryBean
	{
		[DataMember]
		...
		[DataMember]
		public VIMTEMRgatReqprovider VIMTEMRgatReqproviderInfo { get; set; }
		[DataMember]
		public VIMTEMRgatReqpatient VIMTEMRgatReqpatientInfo { get; set; }
	}
	[DataContract]
	public class VIMTEMRgatReqprovider
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
	...
	[DataContract]
	public class VIMTEMRgatReqpatient
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
