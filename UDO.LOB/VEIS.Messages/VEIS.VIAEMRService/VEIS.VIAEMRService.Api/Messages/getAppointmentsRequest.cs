...
namespace VEIS.VIAEMRService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.VIAEMRService,getAppointments method, Request.
	/// Code Generated by IMS on: 12/28/2018 8:56:11 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISEMRgagetAppointmentsRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISEMRgaReqqueryBean VEISEMRgaReqqueryBeanInfo { get; set; }
	}
	[DataContract]
	public class VEISEMRgaReqqueryBean
	{
		[DataMember]
		...
		[DataMember]
		public VIMTEMRgaReqprovider VIMTEMRgaReqproviderInfo { get; set; }
		[DataMember]
		public VIMTEMRgaReqpatient VIMTEMRgaReqpatientInfo { get; set; }
	}
	[DataContract]
	public class VIMTEMRgaReqprovider
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
	...
	[DataContract]
	public class VIMTEMRgaReqpatient
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
