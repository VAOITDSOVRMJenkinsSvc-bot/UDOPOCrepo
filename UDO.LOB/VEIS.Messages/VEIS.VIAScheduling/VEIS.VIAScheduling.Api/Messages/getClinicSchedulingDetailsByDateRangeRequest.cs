...
namespace VEIS.VIAScheduling.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.VIAScheduling,getClinicSchedulingDetailsByDateRange method, Request.
	/// Code Generated by IMS on: 1/24/2019 5:37:10 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISVIASchedGCSDBDRgetClinicSchedulingDetailsByDateRangeRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISVIASchedGCSDBDRReqqueryBean VEISVIASchedGCSDBDRReqqueryBeanInfo { get; set; }
	}
	[DataContract]
	public class VEISVIASchedGCSDBDRReqqueryBean
	{
		[DataMember]
		...
		[DataMember]
		public VIMTVIASchedGCSDBDRReqprovider VIMTVIASchedGCSDBDRReqproviderInfo { get; set; }
		[DataMember]
		public VIMTVIASchedGCSDBDRReqpatient VIMTVIASchedGCSDBDRReqpatientInfo { get; set; }
	}
	[DataContract]
	public class VIMTVIASchedGCSDBDRReqprovider
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
	...
	[DataContract]
	public class VIMTVIASchedGCSDBDRReqpatient
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
