...
namespace VEIS.VIAScheduling.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.VIAScheduling,getConsultDetails method, Request.
	/// Code Generated by IMS on: 1/24/2019 5:39:41 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISVIASchGCDgetConsultDetailsRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISVIASchGCDReqqueryBean VEISVIASchGCDReqqueryBeanInfo { get; set; }
	}
	[DataContract]
	public class VEISVIASchGCDReqqueryBean
	{
		[DataMember]
		...
		[DataMember]
		public VIMTVIASchGCDReqprovider VIMTVIASchGCDReqproviderInfo { get; set; }
		[DataMember]
		public VIMTVIASchGCDReqpatient VIMTVIASchGCDReqpatientInfo { get; set; }
	}
	[DataContract]
	public class VIMTVIASchGCDReqprovider
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
	...
	[DataContract]
	public class VIMTVIASchGCDReqpatient
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
