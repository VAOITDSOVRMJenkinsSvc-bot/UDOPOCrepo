...
namespace VEIS.VIAScheduling.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.VIAScheduling,getConsultStatuses method, Request.
	/// Code Generated by IMS on: 1/24/2019 5:40:56 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISVIASchedGCSgetConsultStatusesRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISVIASchedGCSReqqueryBean VEISVIASchedGCSReqqueryBeanInfo { get; set; }
	}
	[DataContract]
	public class VEISVIASchedGCSReqqueryBean
	{
		[DataMember]
		...
		[DataMember]
		public VIMTVIASchedGCSReqprovider VIMTVIASchedGCSReqproviderInfo { get; set; }
		[DataMember]
		public VIMTVIASchedGCSReqpatient VIMTVIASchedGCSReqpatientInfo { get; set; }
	}
	[DataContract]
	public class VIMTVIASchedGCSReqprovider
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
	...
	[DataContract]
	public class VIMTVIASchedGCSReqpatient
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
