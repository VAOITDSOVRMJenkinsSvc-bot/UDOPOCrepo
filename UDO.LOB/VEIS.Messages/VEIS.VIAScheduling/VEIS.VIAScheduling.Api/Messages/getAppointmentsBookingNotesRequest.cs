...
namespace VEIS.VIAScheduling.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.VIAScheduling,getAppointmentsBookingNotes method, Request.
	/// Code Generated by IMS on: 1/24/2019 5:33:20 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISVIASchedgabngetAppointmentsBookingNotesRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISVIASchedgabnReqqueryBean VEISVIASchedgabnReqqueryBeanInfo { get; set; }
	}
	[DataContract]
	public class VEISVIASchedgabnReqqueryBean
	{
		[DataMember]
		...
		[DataMember]
		public VIMTVIASchedgabnReqprovider VIMTVIASchedgabnReqproviderInfo { get; set; }
		[DataMember]
		public VIMTVIASchedgabnReqpatient VIMTVIASchedgabnReqpatientInfo { get; set; }
	}
	[DataContract]
	public class VIMTVIASchedgabnReqprovider
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
	...
	[DataContract]
	public class VIMTVIASchedgabnReqpatient
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
