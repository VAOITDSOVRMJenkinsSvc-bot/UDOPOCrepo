...
namespace VEIS.VIAScheduling.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.VIAScheduling,getCancellationReasons method, Request.
	/// Code Generated by IMS on: 1/24/2019 5:36:15 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISVIASchedGCRgetCancellationReasonsRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISVIASchedGCRReqqueryBean VEISVIASchedGCRReqqueryBeanInfo { get; set; }
	}
	[DataContract]
	public class VEISVIASchedGCRReqqueryBean
	{
		[DataMember]
		...
		[DataMember]
		public VIMTVIASchedGCRReqprovider VIMTVIASchedGCRReqproviderInfo { get; set; }
		[DataMember]
		public VIMTVIASchedGCRReqpatient VIMTVIASchedGCRReqpatientInfo { get; set; }
	}
	[DataContract]
	public class VIMTVIASchedGCRReqprovider
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
	...
	[DataContract]
	public class VIMTVIASchedGCRReqpatient
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
