...
namespace VEIS.AddressWebService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.AddressWebService,validateAddress method, Response.
	/// Code Generated by IMS on: 1/3/2019 4:26:43 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISvaladdvalidateAddressResponse : VEISEcResponseBase
	{
		[DataMember]
		public VEISvaladdreturnMultipleResponse[] VEISvaladdreturnInfo { get; set; }
	}
	[DataContract]
	public class VEISvaladdreturnMultipleResponse
	{
		[DataMember]
