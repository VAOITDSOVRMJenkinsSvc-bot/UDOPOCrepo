...
namespace VEIS.AddressWebService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.AddressWebService,vnAddressValidator method, Response.
	/// Code Generated by IMS on: 1/3/2019 4:28:22 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISfnaddvalvnAddressValidatorResponse : VEISEcResponseBase
	{
		[DataMember]
		public VEISfnaddvalreturn VEISfnaddvalreturnInfo { get; set; }
	}
	[DataContract]
	public class VEISfnaddvalreturn
	{
		[DataMember]
		...
		[DataMember]
		public VEISfnaddvalgroup1AddressMultipleResponse[] VEISfnaddvalgroup1AddressInfo { get; set; }
	}
	[DataContract]
	public class VEISfnaddvalgroup1AddressMultipleResponse
	{
		[DataMember]
