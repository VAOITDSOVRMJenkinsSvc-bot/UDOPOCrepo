...
namespace VEIS.ClaimantService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.ClaimantService,findGeneralInformationByFileNumber method, Request.
	/// Code Generated by IMS on: 12/19/2018 9:34:26 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISfgenFNfindGeneralInformationByFileNumberRequest : VEISEcRequestBase
	{
		[DataMember]
