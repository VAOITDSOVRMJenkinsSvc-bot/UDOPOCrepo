...
namespace VEIS.ClaimantService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.ClaimantService,findGeneralInformationByPtcpntId method, Response.
	/// Code Generated by IMS on: 12/19/2018 9:36:03 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISfgenpidfindGeneralInformationByPtcpntIdResponse : VEISEcResponseBase
	{
		[DataMember]
		public VEISfgenpidreturn VEISfgenpidreturnInfo { get; set; }
	}
	[DataContract]
	public class VEISfgenpidreturn
	{
		[DataMember]
		...
		[DataMember]
		public VEISfgenpidawardBenesMultipleResponse[] VEISfgenpidawardBenesInfo { get; set; }
		[DataMember]
		public VEISfgenpiddiariesMultipleResponse[] VEISfgenpiddiariesInfo { get; set; }
		[DataMember]
		public VEISfgenpidevrsMultipleResponse[] VEISfgenpidevrsInfo { get; set; }
		[DataMember]
		public VEISfgenpidflashesMultipleResponse[] VEISfgenpidflashesInfo { get; set; }
	}
	[DataContract]
	public class VEISfgenpidawardBenesMultipleResponse
	{
		[DataMember]
		...
		[DataMember]
		public VEISfgenpidawardBenePK VEISfgenpidawardBenePKInfo { get; set; }
	}
	[DataContract]
	public class VEISfgenpidawardBenePK
	{
		[DataMember]
		public string mcs_awardTypeCd { get; set; }
		[DataMember]
	...
	[DataContract]
	public class VEISfgenpiddiariesMultipleResponse
	{
		[DataMember]
	...
	[DataContract]
	public class VEISfgenpidevrsMultipleResponse
	{
		[DataMember]
	...
	[DataContract]
	public class VEISfgenpidflashesMultipleResponse
	{
		[DataMember]
