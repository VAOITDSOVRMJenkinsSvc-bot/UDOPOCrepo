...
namespace VEIS.VIAMHV.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.VIAMHV,getAppointmentsFromSite method, Request.
	/// Code Generated by IMS on: 1/24/2019 5:28:54 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISVIAMHVgafsgetAppointmentsFromSiteRequest : VEISEcRequestBase
	{
		[DataMember]
		...
		[DataMember]
		public VEISVIAMHVgafsReqqueryBean VEISVIAMHVgafsReqqueryBeanInfo { get; set; }
	}
	[DataContract]
	public class VEISVIAMHVgafsReqqueryBean
	{
		[DataMember]
		...
		[DataMember]
		public VIMTVIAMHVgafsReqprovider VIMTVIAMHVgafsReqproviderInfo { get; set; }
		[DataMember]
		public VIMTVIAMHVgafsReqpatient VIMTVIAMHVgafsReqpatientInfo { get; set; }
	}
	[DataContract]
	public class VIMTVIAMHVgafsReqprovider
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
	...
	[DataContract]
	public class VIMTVIAMHVgafsReqpatient
	{
		[DataMember]
		public string mcs_name { get; set; }
		[DataMember]
