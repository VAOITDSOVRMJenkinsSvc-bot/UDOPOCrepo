...
namespace VEIS.EBenefitsBnftClaimStatusService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.EBenefitsBnftClaimStatusService,findHistoricalBenefitClaimsStatusBySSN method, Response.
	/// Code Generated by IMS on: 12/21/2018 1:43:48 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISfindHistBCStatBySSN_findHistoricalBenefitClaimsStatusBySSNResponse : VEISEcResponseBase
	{
		[DataMember]
		public VEISfindHistBCStatBySSN_benefitClaimDTOMultipleResponse[] VEISfindHistBCStatBySSN_benefitClaimDTOInfo { get; set; }
	}
	[DataContract]
	public class VEISfindHistBCStatBySSN_benefitClaimDTOMultipleResponse
	{
		[DataMember]
