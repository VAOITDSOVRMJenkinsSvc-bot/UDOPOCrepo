...
namespace VEIS.EBenefitsBnftClaimStatusService.Messages
{
	[DataContract]
	/// <summary>
	/// VEIS Enterprise Component for VEIS.EBenefitsBnftClaimStatusService,findBenefitClaimsStatusBySSN method, Response.
	/// Code Generated by IMS on: 12/21/2018 1:42:43 PM
	/// Version: 2018.12.11.01
	/// </summary>
	/// <param name=none></param>
	/// <returns>none</returns>
	public class VEISfindBCStatBySSN_findBenefitClaimsStatusBySSNResponse : VEISEcResponseBase
	{
		[DataMember]
		public VEISfindBCStatBySSN_benefitClaimDTOMultipleResponse[] VEISfindBCStatBySSN_benefitClaimDTOInfo { get; set; }
	}
	[DataContract]
	public class VEISfindBCStatBySSN_benefitClaimDTOMultipleResponse
	{
		[DataMember]
