...
namespace VRM.Integration.UDO.MVI.Messages
{
    ...
    [ExportMetadata("MessageType", MessageRegistry.UDOSelectedPersonRequest)]
    [DataContract]
    public class UDOSelectedPersonRequest : MessageBase
    {
        [DataMember]
        ...
        [DataMember]
        public bool AlreadySearchedCorp { get; set; }
        [DataMember]
