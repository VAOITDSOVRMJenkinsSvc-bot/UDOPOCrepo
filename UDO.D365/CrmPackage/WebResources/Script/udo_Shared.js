...
if (typeof UDO === 'undefined') { var UDO = { __namespace: true }; }
...
UDO.Shared.SetRequired = function (fieldName, requiredLevel) {
    ...
    if (UDO.Shared.FormContext === null && parent.Xrm.Page.getAttribute(fieldName) !== null) {
        parent.Xrm.Page.getAttribute(fieldName).setRequiredLevel(requiredLevel);
    }
    else if (UDO.Shared.FormContext.getAttribute(fieldName) !== null) {
...
UDO.Shared.GetFormContext = function (executionContext) {
    if (executionContext !== null && executionContext !== "undefined") {
        if (UDO.Shared.FormContext === null) UDO.Shared.FormContext = executionContext.getFormContext();
    }
}
