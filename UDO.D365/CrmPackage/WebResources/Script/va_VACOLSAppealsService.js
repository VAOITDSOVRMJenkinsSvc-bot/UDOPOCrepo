...
ws.appeals.initalize = function() {
    ...
    appealsWebService.prototype = new webservice;
    ...
    findAppeals.prototype.getSearchParameter = function () {
        ...
        var userSelection = Xrm.Page.getAttribute('va_findappealsby').getSelectedOption();
        if (!userSelection || userSelection.length == 0) { return searchPar; }

        if (userSelection == 'SSN')
            { searchPar = this.context.parameters['ssn']; }
        else if (userSelection == 'This Value')
            { searchPar = Xrm.Page.getAttribute('va_appealssearchtext').getValue(); }
    ...
    updateAppellantAddress.prototype.buildSoapBodyInnerXml = function () {
        ...
        var innerXml;
        //var ssn = this.getSearchParameter(); // this.context.parameters['fileNumber'];
        ...
        innerXml += '<AppellantAddressLine1>' + NN(Xrm.Page.getAttribute('va_apellantaddress1').getValue()) + '</AppellantAddressLine1>' +
            '<AppellantAddressLine2>' + NN(Xrm.Page.getAttribute('va_apellantaddress2').getValue()) + '</AppellantAddressLine2>' +
            '<AppellantAddressCityName>' + NN(Xrm.Page.getAttribute('va_apellantcity').getValue()) + '</AppellantAddressCityName>' +
            '<AppellantAddressStateCode>' + NN(Xrm.Page.getAttribute('va_apellantstate').getValue()) + '</AppellantAddressStateCode>' +
            '<AppellantAddressZipCode>' + NN(Xrm.Page.getAttribute('va_apellantzipcode').getValue()) + '</AppellantAddressZipCode>' +
            '<AppellantAddressCountryName>' + NN(Xrm.Page.getAttribute('va_apellantcountry').getValue()) + '</AppellantAddressCountryName>' +         '<AppellantAddressNotes>' + NN(Xrm.Page.getAttribute('va_appellantaddressnotes').getValue()) + '</AppellantAddressNotes>' +
            '<AppellantWorkPhoneNumber>' + NN(Xrm.Page.getAttribute('va_apellantworkphone').getValue()) + '</AppellantWorkPhoneNumber>' +
            '<AppellantHomePhoneNumber>' + NN(Xrm.Page.getAttribute('va_apellanthomephone').getValue()) + '</AppellantHomePhoneNumber>' +
