...
veteranGeneralInformationPK.prototype.performAction = function () {
    ...
    var succesfulRequest = findGeneralInformationByPtcpntIds.executeRequest();
    ...
    if (!succesfulRequest) {
        ...
        this.actionMessage.description = 'Find Veteran General Information By Participant Ids request failed.';
