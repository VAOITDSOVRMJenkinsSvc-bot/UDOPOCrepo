// Do not use strict mode, this causes IE issues for WalkIns
//"use strict";
...
(function (CrmCommonJS) {
    var FormHelper = (function () {
            ...
            if (att) {
                ...
                switch (level) {
                    ...
                    case undefined:
                        ...
                        break;
                    default:
                        var message = level + " is an invalid submit mode. Pass 'requried', 'recommended', 'none' or a boolean to this method";
                        UDO.Shared.openAlertDialog(message);
                        return;
                }
        ...
        FormHelper.prototype.setSubmitMode = function (fieldName, submitMode) {
            ...
            switch (submitMode) {
                ...
                case false:
                    ...
                    break;
                default:
                    var message = submitMode + " is an invalid submit mode. Pass 'always', 'dirty', 'never' or a boolean to this method";
                    UDO.Shared.openAlertDialog(message);
                    return;
            }
        ...
        FormHelper.prototype.setFormNotification = function (message, level, messageName) {
            ...
            switch (level) {
                ...
                case "INFO":
                    ...
                    break;
                default:
                    var message = "Invald notification level. Select 'ERROR', 'WARNING' or 'INFO'";
                    UDO.Shared.openAlertDialog(message);
        ...
        FormHelper.prototype.saveRecord = function (refresh) {
            ...
            FormHelper.formContext.data.save(refresh);
        };
...
(function (CrmCommonJS) {
    var Notification = (function () {
        ...
        Notification.prototype._AddNotification = function (msg, lvl, id) {
            ...
            formContext.ui.setFormNotification(msg, lvl, id);
            this._ids.push(id);
        };
...
(function (CrmCommonJS) {
    var Security = (function () {
        function Security(webApi) {
            ...
            if (typeof globalCon.userSettings.roles !== 'undefined') {
                var roleColl = globalCon.userSettings.roles;
                for (var item = 0; item <= roleColl.getLength() - 1; item++) {
                    var role = roleColl.get(item);
                    rolGuids.push(role.id);
                }
                this._roleGuids = rolGuids;
            }
            else {
    ...
    var WebApi = (function () {
        function WebApi(CrmVersion) {
            ...
            this.ODataEntityName = {
                Role: "role", Team: "team", TeamMembership: "teammembership"
            };
        }
        ...
        WebApi.prototype.ExecuteRequest = function (metaData, data) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                Xrm.WebApi.online.execute(reqObj).then(function (response) {
