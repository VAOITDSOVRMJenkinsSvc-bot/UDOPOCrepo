...
function updateAttribute(attributeName, attributeValue) {
    try {
        ...
        Va.Udo.Crm.Scripts.Popup
                .MsgBox("Could not update caller details on the Interaction.\nTry editing the Interaction fields and saving directly.",
                    Va.Udo.Crm.Scripts.Popup.PopupStyles.Critical,
                    "Interaction Update Error",
{ height: 200, width: 350 });
    }
}
updateAttribute("udo_relationship", 752280000);
updateAttribute("udo_firstname", "[[udo_veteransnapshot.udo_firstname]+]");
updateAttribute("udo_lastname", "[[udo_veteransnapshot.udo_lastname]+]");
if ("[[udo_veteransnapshot.udo_phonenumber]+]" != "") {
    updateAttribute("udo_phonenumber", "[[udo_veteransnapshot.udo_phonenumber]+]");
    updateAttribute("udo_nophonenumberavailable", 0);
}
updateAttribute("udo_iscallerauthorized", 1);
Xrm.Page.data.save();