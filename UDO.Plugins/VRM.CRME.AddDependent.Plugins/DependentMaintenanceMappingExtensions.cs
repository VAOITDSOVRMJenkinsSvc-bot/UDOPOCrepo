...
namespace VRM.CRME.Plugin.DependentMaintenance
{
    ...
    {
        public static crme_dependentmaintenance MapVeteranInfo(this GetVeteranInfoMultipleResponse vaData,
        ...
        public static crme_dependent MapDependentInfo(this GetDependentInfoMultipleResponse vaData,
            ...
            OrganizationServiceContext context)
        {
            ...
            crmDependent.crme_name = vaData.crme_FirstName + " " + vaData.crme_LastName;
            ...
            if (vaData.crme_MarriageDate != null && !string.IsNullOrEmpty(vaData.crme_MarriageDate))
            {
                var responseDate = vaData.crme_MarriageDate;
                var month = responseDate.Substring(0, 2);
                var day = responseDate.Substring(2, 2);
                var year = responseDate.Substring(4, 4);

                DateTime marriageDate = new DateTime(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(day));
                crmDependent.crme_MarriageDate = marriageDate;
                // crmDependent.crme_MarriageDate = Convert.ToDateTime(vaData.crme_MarriageDate);
            }
            ...
            if (vaData.crme_DOB != null && !string.IsNullOrEmpty(vaData.crme_DOB))
            {
                var responseDateOfBirth = vaData.crme_DOB;
                var month = responseDateOfBirth.Substring(0, 2);
                var day = responseDateOfBirth.Substring(2, 2);
                var year = responseDateOfBirth.Substring(4, 4);

                DateTime dateOfBirth = new DateTime(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(day));
                crmDependent.crme_DOB = dateOfBirth;
           ...
           // crmDependent.crme_name = vaData.crme_name;
            if (vaData.crme_RelationshipBeginDate != null && !string.IsNullOrEmpty(vaData.crme_RelationshipBeginDate))
            {
                var responseDate = vaData.crme_RelationshipBeginDate;
                var month = responseDate.Substring(0, 2);
                var day = responseDate.Substring(2, 2);
                var year = responseDate.Substring(4, 4);

                DateTime relationshipBeginDate = new DateTime(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(day));
                crmDependent.crme_RelationshipBeginDate = relationshipBeginDate;
                //crmDependent.crme_RelationshipBeginDate = Convert.ToDateTime(vaData.crme_RelationshipBeginDate);
            }
            if (vaData.crme_RelationshipEndDate != null && !string.IsNullOrEmpty(vaData.crme_RelationshipEndDate))
            {
                var responseDate = vaData.crme_RelationshipEndDate;
                var month = responseDate.Substring(0, 2);
                var day = responseDate.Substring(2, 2);
                var year = responseDate.Substring(4, 4);

                DateTime relationshipEndDate = new DateTime(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(day));
                crmDependent.crme_RelationshipEndDate = relationshipEndDate;
                // crmDependent.crme_RelationshipEndDate = Convert.ToDateTime(vaData.crme_RelationshipEndDate);
            }
        ...
        public static crme_maritalhistory MapMaritalHistoryInfo(this GetMaritalInfoMultipleResponse vaData,
            crme_dependentmaintenance dependentMaintenance,
            ...
            OrganizationServiceContext context)
        {
            ...
            if (vaData.crme_MarriageStartDate != null && !string.IsNullOrEmpty(vaData.crme_MarriageStartDate))
            {
                var responseDate = vaData.crme_MarriageStartDate;
                var month = responseDate.Substring(0, 2);
                var day = responseDate.Substring(2, 2);
                var year = responseDate.Substring(4, 4);

                DateTime marriageStartDate = new DateTime(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(day));
                crmMaritalhistory.crme_MarriageStartDate = marriageStartDate;
                //crmMaritalhistory.crme_MarriageStartDate = Convert.ToDateTime(vaData.crme_MarriageStartDate);
            }
            if (vaData.crme_MarriageEndDate != null && !string.IsNullOrEmpty(vaData.crme_MarriageEndDate))
            {
                var responseDate = vaData.crme_MarriageEndDate;
                var month = responseDate.Substring(0, 2);
                var day = responseDate.Substring(2, 2);
                var year = responseDate.Substring(4, 4);

                DateTime marriageEndDate = new DateTime(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(day));
                crmMaritalhistory.crme_MarriageEndDate = marriageEndDate;
                //crmMaritalhistory.crme_MarriageEndDate = Convert.ToDateTime(vaData.crme_MarriageEndDate);
            }
            crmMaritalhistory.crme_LastName = vaData.crme_LastName;
            crmMaritalhistory.crme_FirstName = vaData.crme_FirstName;
            if (vaData.crme_DOB != null && !string.IsNullOrEmpty(vaData.crme_DOB))
            {
                var responseDate = vaData.crme_DOB;
                var month = responseDate.Substring(0, 2);
                var day = responseDate.Substring(2, 2);
                var year = responseDate.Substring(4, 4);

                DateTime dateOfBirth = new DateTime(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(day));
                crmMaritalhistory.crme_DOB = dateOfBirth;
                // crmMaritalhistory.crme_DOB = Convert.ToDateTime(vaData.crme_DOB);
            }
            ...
            if (vaData.crme_RelationshipBeginDate != null && !string.IsNullOrEmpty(vaData.crme_RelationshipBeginDate))
            {
                ...
                DateTime relationshipBeginDate = new DateTime(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(day));
                crmMaritalhistory.crme_RelationshipBeginDate = relationshipBeginDate;
                //crmMaritalhistory.crme_RelationshipBeginDate = Convert.ToDateTime(vaData.crme_RelationshipBeginDate);
            }
            if (vaData.crme_RelationshipEndDate != null && !string.IsNullOrEmpty(vaData.crme_RelationshipEndDate))
            {
                var responseDate = vaData.crme_RelationshipEndDate;
                ...
                DateTime relationshipEndDate = new DateTime(Convert.ToInt32(year), Convert.ToInt32(month), Convert.ToInt32(day));
                crmMaritalhistory.crme_RelationshipEndDate = relationshipEndDate;
                //crmMaritalhistory.crme_RelationshipEndDate = Convert.ToDateTime(vaData.crme_RelationshipEndDate);
            }
