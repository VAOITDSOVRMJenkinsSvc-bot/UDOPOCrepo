...
namespace VA.AppInsights
{
    ...
    public class BaseData
    {
        ...
        public string CustomDimensionsReplacementString { get; set; }
        ...
        public string CustomMeasuresReplacementString { get; set; }
    ...
    public class Request : BaseData
    {
        ...
        public Request(string id, double durationInSeconds, string name, string source, bool success, Dictionary<string, string> customDimensions, Dictionary<string, double> customMeasurements, string responseCode = "") : base(name)
        {
            this.source = source;
            this.success = success;
            var durationSpan = TimeSpan.FromSeconds(durationInSeconds);
