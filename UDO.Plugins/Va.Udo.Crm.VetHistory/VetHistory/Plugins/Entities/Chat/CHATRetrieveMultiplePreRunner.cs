...
{
    internal class CHATRetrieveMultiplePreRunner : PluginRunner
    {
        Guid _veteranId = new Guid();
        string _ssn = "";
        const string Query = "Query";
        public CHATRetrieveMultiplePreRunner(IServiceProvider serviceProvider)
            ...
            try
            {
                ...
                if (PluginExecutionContext.InputParameters["Query"] is QueryExpression)
                {
                    foreach (var item in criteria)
                    {
                        ...
                        if (item.AttributeName.Equals("crme_ssn"))
                        {
                    ...
                    if (didWeNeedData())
                    {
                        if (blnBefore)
                        {
                            ...
                            query.LinkEntities.Add(new LinkEntity
                            {
                                ...
                                LinkFromAttributeName = "crme_phonecallid",
                                LinkFromEntityName = "crme_chatcobrowsesessionlog",
