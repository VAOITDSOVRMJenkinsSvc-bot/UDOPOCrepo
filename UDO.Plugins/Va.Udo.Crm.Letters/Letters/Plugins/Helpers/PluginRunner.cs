        ...
        public virtual bool CheckPluginSwitch(string pluginName)
        {
            switch (pluginName)
            {
                case "IDProofCreatePostStageRunner":
                    ...
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.geteBenefitsLogToAI);
                    return ((bool?)_McsSettings.geteBenefitsLogToAI ?? false);
                case "UDOGetVeteranSnapshotRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getVeteranSnapshotLogToAI);
                    return ((bool?)_McsSettings.getVeteranSnapshotLogToAI ?? false);
                case "UDOGetAwardsRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getAwardsLogToAI);
                    return ((bool?)_McsSettings.getAwardsLogToAI ?? false);
                case "UDOGetClaimsRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getClaimsLogToAI);
                    return ((bool?)_McsSettings.getClaimsLogToAI ?? false);
                case "UDOGetContactUpdatesRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getContactsLogToAI);
                    return ((bool?)_McsSettings.getContactsLogToAI ?? false);
                case "GetFiduciaryExistsRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getFiduciaryLogToAI);
                    return ((bool?)_McsSettings.getFiduciaryLogToAI ?? false);
                case "GetFlashesRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getFlashLogToAI);
                    return ((bool?)_McsSettings.getFlashLogToAI ?? false);
                case "UDOInitiateLetterRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getLetterLogToAI);
                    return ((bool?)_McsSettings.getLetterLogToAI ?? false);
                case "UDOInitiateNotesRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getNotesLogToAI);
                    return ((bool?)_McsSettings.getNotesLogToAI ?? false);
                case "UDOGetRatingsRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getRatingsLogToAI);
                    return ((bool?)_McsSettings.getRatingsLogToAI ?? false);
                case "UDOGetVBMSeFolderRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getVBMSEFolderLogToAI);
                ...
                case "IdProofPostCreateRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getIDProofLogToAI);
                    return ((bool?)_McsSettings.getIDProofLogToAI ?? false);
                case "InteractionCloseRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getInteractionLogToAI);
                ...
                case "RequestPostCreateRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getRequestLogToAI);
                ...
                case "GenerateDocumentPostRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getSSRSLogToAI);
                    return ((bool?)_McsSettings.getSSRSLogToAI ?? false);
                case "CreateAnnotationPreRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getVBMSLogToAI);
                    return ((bool?)_McsSettings.getVBMSLogToAI ?? false);
                case "UDOPersonRetrieveMultiplePostStageRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getMVISearchLogToAI);
                ...
                case "UDOInitiateSRRunner":
                    TracingService.Trace("Value of PluginName is: " + pluginName);
                    TracingService.Trace("Value of the Setting is: " + _McsSettings.getServiceRequestLogToAI);
