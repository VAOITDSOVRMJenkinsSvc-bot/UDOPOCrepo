Ext.define('VIP.soap.envelopes.share.BenefitClaimDetailsByBnftClaimIdTemplate', {
    extend: 'VIP.soap.envelopes.VARequestBuilder',
    config: {
        serviceUrl: 'EBenefitsBnftClaimStatusWebServiceBean/EBenefitsBnftClaimStatusWebService',
        isDacRequest: true
    },
