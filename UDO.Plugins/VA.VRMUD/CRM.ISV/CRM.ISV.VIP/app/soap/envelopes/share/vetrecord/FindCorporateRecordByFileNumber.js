Ext.define('VIP.soap.envelopes.share.vetrecord.FindCorporateRecordByFileNumber', {
    extend: 'VIP.soap.envelopes.share.VetRecordTemplate',
    alias: 'envelopes.FindCorporateRecordByFileNumber',
    config: {
        fileNumber: ''
    },
    ...
    constructor: function (config) {
        ...
        me.setBody('findCorporateRecordByFileNumber', {
            namespace: 'ser',
            fileNumber: {
                namespace: '',
