var pageData = {
    ...
    "SaveMode": 1,
    "EventSource": null,
    "AuthenticationHeader": "&lt;soap:Header&gt;&lt;CrmAuthenticationToken xmlns="http&#58;&#47;&#47;schemas.microsoft.com&#47;crm&#47;2007&#47;WebServices"&gt;&lt;AuthenticationType xmlns="http&#58;&#47;&#47;schemas.microsoft.com&#47;crm&#47;2007&#47;CoreTypes"&gt;0&lt;/AuthenticationType&gt;&lt;CrmTicket xmlns="http&#58;&#47;&#47;schemas.microsoft.com&#47;crm&#47;2007&#47;CoreTypes"&gt;&lt;/CrmTicket&gt;&lt;OrganizationName xmlns="http&#58;&#47;&#47;schemas.microsoft.com&#47;crm&#47;2007&#47;CoreTypes"&gt;Catapult&lt;/OrganizationName&gt;&lt;CallerId xmlns="http&#58;&#47;&#47;schemas.microsoft.com&#47;crm&#47;2007&#47;CoreTypes"&gt;ECB76AE7-480B-E111-BC15-080027D9673C&lt;/CallerId&gt;&lt;/CrmAuthenticationToken&gt;&lt;/soap:Header&gt;",
    "CurrentTheme": "Default",
    "OrgLcid": 1033,
    "OrgUniqueName": "Catapult",
    "QueryStringParameters": { "_gridType": "1", "etc": "1", "id": "{84EACDB8-EB0B-E111-9BBC-080027D9673C}", "pagemode": "iframe", "rskey": "991146681", "sitemappath": "Workplace|MyWork|nav_dashboards" },
    "ServerUrl": "http://crm2011/Catapult",
    "UserId": "{ECB76AE7-480B-E111-BC15-080027D9673C}",
    "UserLcid": 1033,
    "UserRoles": ["f72a73df-480b-e111-bc15-080027d9673c"],
    "isOutlookClient": false,
    "isOutlookOnline": true,
    "DataXml": "&lt;account&gt;&lt;/account&gt;",
    "EntityName": "account",
    "Id": "{84EACDB8-EB0B-E111-9BBC-080027D9673C}",
    "IsDirty": false,
    "CurrentControl": null,
    "CurrentForm": null,
    "Forms": [],
    ...
    "AttributesLength": 53,
    "Attributes": [
    { "Name": "name", "Value": "Downtown Gym", "Type": "string", "Format": "text", "IsDirty": false, "RequiredLevel": "required", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 160, "Controls": [{ "Name": "name"}] },
    { "Name": "telephone1", "Value": "555-0174", "Type": "string", "Format": "text", "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 50, "Controls": [{ "Name": "telephone1"}] },
    { "Name": "primarycontactid", "Value": null, "Type": "lookup", "Format": null, "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "Controls": [{ "Name": "primarycontactid"}] },
    ...
    { "Name": "accountnumber", "Value": null, "Type": "string", "Format": "text", "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 20, "Controls": [{ "Name": "accountnumber"}] },
    ...
    { "Name": "emailaddress1", "Value": null, "Type": "string", "Format": "email", "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 100, "Controls": [{ "Name": "emailaddress1"}] },
    ...
    { "Name": "address1_city", "Value": "Redmond", "Type": "string", "Format": "text", "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 80, "Controls": [{ "Name": "address1_city"}] },
    ...
    { "Name": "address1_stateorprovince", "Value": null, "Type": "string", "Format": "text", "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 50, "Controls": [{ "Name": "address1_stateorprovince"}] },
    { "Name": "address1_line1", "Value": "123454", "Type": "string", "Format": "text", "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 250, "Controls": [{ "Name": "address1_line1"}] },
    { "Name": "address1_postalcode", "Value": null, "Type": "string", "Format": "text", "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 20, "Controls": [{ "Name": "address1_postalcode"}] },
    ...
    { "Name": "address1_country", "Value": null, "Type": "string", "Format": "text", "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 80, "Controls": [{ "Name": "address1_country"}] },
    ...
    { "Name": "transactioncurrencyid", "Value": [{ "entityType": "transactioncurrency", "id": "{5C2DB24C-490B-E111-BC15-080027D9673C}", "name": "US Dollar"}], "Type": "lookup", "Format": null, "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "Controls": [{ "Name": "transactioncurrencyid"}] },
    ...
    { "Name": "ownerid", "Value": [{ "entityType": "systemuser", "id": "{ECB76AE7-480B-E111-BC15-080027D9673C}", "name": "First name Last name"}], "Type": "lookup", "Format": null, "IsDirty": false, "RequiredLevel": "required", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "Controls": [{ "Name": "ownerid"}] },
    ...
    { "Name": "address1_addressid", "Value": "{2C552B34-C416-47B5-AD9E-7A7BDA259D40}", "Type": "string", "Format": null, "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 1.7976931348623157e+308, "Controls": [] },
    { "Name": "address2_addressid", "Value": "{D4371745-794B-4B22-81D3-4C9168EC6AE1}", "Type": "string", "Format": null, "IsDirty": false, "RequiredLevel": "none", "SubmitMode": "dirty", "UserPrivilege": { "canRead": true, "canUpdate": true, "canCreate": true }, "MaxLength": 1.7976931348623157e+308, "Controls": [] }
 ],
    "ControlsLength": 54,
    "Controls": [
