...
ws.vetRecord.initalize = function() {
    //=====================================================================================================
    ...
    vetRecordWebService.prototype = new webservice;
    ...
    findBirlsRecord.prototype.buildSoapBodyInnerXml = function () {
        ...
        var firstName = (Xrm.Page.data.entity.getEntityName() == 'contact' ? Xrm.Page.getAttribute('firstname').getValue() : Xrm.Page.getAttribute('va_firstname').getValue()); 
        var lastName = (Xrm.Page.data.entity.getEntityName() == 'contact' ? Xrm.Page.getAttribute('lastname').getValue() : Xrm.Page.getAttribute('va_lastname').getValue()); 
        ...
        var moreSearchOptions = (Xrm.Page.getAttribute('va_moresearchoptions') && Xrm.Page.getAttribute('va_moresearchoptions').getValue() == true); 
        ...
        params['middleName'] = Xrm.Page.getAttribute('va_middleinitial').getValue();    
        params['dateOfBirth'] = null; if (dobDate) params['dateOfBirth'] = dobDate.format("MMddyyyy");

        if (moreSearchOptions) {
            // BIRLS Only
            params['fileNumber'] = Xrm.Page.getAttribute('va_ssn').getValue();
            params['ssn'] = Xrm.Page.getAttribute('va_ssn').getValue();
            params['insuranceNumber'] = Xrm.Page.getAttribute('va_insurancenumber').getValue();
            params['serviceNumber'] = Xrm.Page.getAttribute('va_servicenumber').getValue();
            params['branchOfService'] = Xrm.Page.getAttribute('va_branchofservice').getValue();
            params['dateOfDeath'] = null; if (Xrm.Page.getAttribute('va_dod').getValue()) params['dateOfDeath'] = Xrm.Page.getAttribute('va_dod').getValue().format("MMddyyyy");
            params['enteredOnDutyDate'] = null; if (Xrm.Page.getAttribute('va_enteredondutydate').getValue()) params['enteredOnDutyDate'] = Xrm.Page.getAttribute('va_enteredondutydate').getValue().format("MMddyyyy");
            params['releasedActiveDutyDate'] = null; if (Xrm.Page.getAttribute('va_releasedactivedutydate').getValue()) params['releasedActiveDutyDate'] = Xrm.Page.getAttribute('va_releasedactivedutydate').getValue().format("MMddyyyy");
            params['folderLocation'] = Xrm.Page.getAttribute('va_folderlocation').getValue();
            params['suffix'] = Xrm.Page.getAttribute('va_suffix').getValue();
            params['payeeNumber'] = Xrm.Page.getAttribute('va_payeenumber').getValue();
        }
    ...
    findCorporateRecord.prototype.buildSoapBodyInnerXml = function () {
        ...
        if (moreSearchOptions) {
            ...
            params['city'] = Xrm.Page.getAttribute('va_citysearch').getValue();
            params['state'] = Xrm.Page.getAttribute('va_statesearch').getValue();
            params['zipCode'] = Xrm.Page.getAttribute('va_zipcodesearch').getValue();
        }
