    ...
    updateBenefitClaimAddress.prototype.buildSoapBodyInnerXml = function() {
        ...
        innerXml =
            '<ser:updateBenefitClaimAddress><cInput>' +
                ...
                '<eftRoutingNumber>' + NN(Xrm.Page.getAttribute('va_routingnumber').getValue()) + '</eftRoutingNumber>' +
                '<eftAccountNumber>' + NN(Xrm.Page.getAttribute('va_depositaccountnumber').getValue()) + '</eftAccountNumber>';
