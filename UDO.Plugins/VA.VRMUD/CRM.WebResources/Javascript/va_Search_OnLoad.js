...
var intervalId = null;
function doOnLoad() {
    intervalId = setInterval(hideJewel, 500);
}

function hideJewel() {
    var a = window.parent.document.getElementById("jewelcontainer");
    if (a != null) {
...
function onFormLoad() {
    ...
    Xrm.Page.getControl('IFRAME_search').setSrc(serverUrl + '/ISV/VIP/index.html');
    ...
    var ga = Xrm.Page.getAttribute, gc = Xrm.Page.getControl;
    ...
    ////    ga("va_dispositionsubtype4").setValue(ga("va_dispositionsubtype5").getValue());
    ////}
...
function ActionOnEnter() {
    ...
    if (startSection.getVisible()) {
        ...
        Xrm.Page.getControl('va_firstname').setFocus();
        Xrm.Page.getControl('va_ssn').setFocus();
        SearchOnClick();
    }
}
...
function CheckPriorCalls() {
    try {
        ...
        var query = Xrm.Page.context.getServerUrl() + 'XRMServices/2011/OrganizationData.svc' + "/" + "PhoneCallSet"
