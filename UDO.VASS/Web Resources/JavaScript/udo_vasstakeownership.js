...
VASS.Transfer = {
    ...
    callTransferWorkflow: function (primaryEntityId, primaryControl) {
        Xrm.Navigation.openConfirmDialog({ "confirmButtonLabel": "Yes", "cancelButtonLabel":"No","title": "Transfer Ownership", "text": "Would you like to take ownership of current and future VASS interactions for this Veteran?" }, null).then(
            function () {
