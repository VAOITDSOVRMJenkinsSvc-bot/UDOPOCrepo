...
VASS.Interaction.LoadInteractionResolverMenu = function (commandProperties) {
    /*{SourceControlId: 'udo_interaction|NoRelationship|Form|udo.udo_interaction.Close.Button', 
    CommandValueId: null
    }*/
    var commandId = "";
    ...
    /*var menuItems = [
        ...
        "<Button Command='udo.udo_interaction.CloseSuccess.Command' Id='udo.udo_interaction.CloseSuccess.Button2' LabelText='Successful Contact Made2' Sequence='10' ModernImage='$webresource:udo_check-32.svg' IsEnabled='False' />",
        "<Button Command='udo.udo_interaction.CloseFailure.Command' Id='udo.udo_interaction.CloseFailure.Button2' LabelText='Failed to Make Contact2' Sequence='15' ModernImage='$webresource:udo_wrong-32.svg' IsDisabled='True' />",
        "<Button Command='udo.udo_interaction.CloseLateEntry.Command' Id='udo.udo_interaction.CloseLateEntry.Button2' LabelText='Late Entry - Unable to Contact2' Sequence='20' ModernImage='$webresource:udo_message-warning-red-16.svg' />",
